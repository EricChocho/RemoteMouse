package com.viewsonic.remotemouse.helper;
...
public class KeyDetection extends AppCompatActivity {
    ...
    public static void changeBossKey(int keyCode){
        ...
        builder.setTitle(R.string.Confirm1);
        String F;
        F = R.string.Confirm2+"\""+keyCode+"\""+R.string.Confirm3;
        //builder.setMessage(F);
        builder.setMessage(activity.getString(R.string.Confirm2)+" \""+ keyCode + "\""+activity.getString(R.string.Confirm3));
        builder.setPositiveButton("YES", (dialogInterface, i) -> {
            ...
            bossKey = keyCode;
            Toast.makeText(activity, activity.getString(R.string.Confirm4)+keyCode, Toast.LENGTH_SHORT).show();
